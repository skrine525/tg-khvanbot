...
MESSAGE_CONSULTATION_DELETING_CONFIRMATION = "⚙️ Вы уверены, что хотите удалить текущую заявку на консультацию?"
MESSAGE_CONSULTATION_DELETED = "✅ Заявка на консультацию успешно удалена."
MESSAGE_CONSULTATION_DELETED_BY_USER = "⛔️ Консультация №{consultation_id} удалена пользователем."
MESSAGE_CONSULTATION_EDITED = "✅ Заявка на консультацию отредактирована."

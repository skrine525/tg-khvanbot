...
MESSAGE_CONSULTATION_STATUS_PROCESSED = "✅ Обработана"
MESSAGE_CONSULTATION_STATUS_NOT_PROCESSED = "❌ Не обработана"
...
MESSAGE_CONSULTATION_QUESTION_MARK_AS_PROCESSED = "Вы хотите пометить консультацию как *обработанную*?"
...
BUTTON_CONSULTATION_MARK_AS_PROCESSED = "🔘 Обработано"

...
MESSAGE_CONSULTATION_STAGE_1 = "Отлично! Давайте запишем вас на консультацию.\n\nДля начала необходимо указать номер телефона. Вы можете:\n1️⃣ Предоставить номер Telegram\n2️⃣ Указать другой номер без кода +7."
...
MESSAGE_CONSULTATION_STAGE_6 = "✅ Анкета заполнена. Теперь выберите удобное время консультации."

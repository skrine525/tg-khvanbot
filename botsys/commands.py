...
from botsys.ui.basic import RegistrationCommand, ConsultationCommand, MenuCommand, AdminPanel
...
def register_commands(bot: Bot):
    ...
    bot.register_callback_query_command(strcontent.COMMAND_CALLBACK_QUERY_ADMIN_PANEL, AdminPanel.callback_query_command)
    bot.register_callback_query_command(strcontent.COMMAND_CALLBACK_QUERY_MENU, MenuCommand.callback_query_command)
